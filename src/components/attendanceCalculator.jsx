...
export const calculateOverallAttendancePercentage = (subjectAttendance) => {
  // Supporte les mocks simples (ex: {subject, attended, total})
  if (
    Array.isArray(subjectAttendance) &&
    subjectAttendance.length > 0 &&
    subjectAttendance[0].attended !== undefined
  ) {
    let totalAttended = 0;
    let totalSessions = 0;
    ...
    return (totalAttended / totalSessions) * 100;
  }
  // Ancien format (avec subName)
